...
/* ==========================================================================
   ...
   ========================================================================== */
const prev = el('div', 'dock-prev glass');
...
/* ==========================================================================
   6. Диалог «Выполнить» (Super+R) и системные горячие клавиши
   ========================================================================== */
...
const runDlg = el('div', 'run-dlg glass');
runDlg.innerHTML = `<h4>Выполнить</h4>
  <p>Введите имя программы, и система откроет её: блокнот, калькулятор, терминал, проводник, параметры, диспетчер…</p>
