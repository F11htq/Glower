...
const I18N = {
  ...
  DICT:{ en:{
    ...
    'Форма поверхностей':'Surface shape',
    ...
    /* железо и устройства настоящей машины */
    'Оборудование':'Hardware', 'Процессор':'Processor', 'Оперативная память':'Memory',
    'Система':'System', 'Имя машины':'Machine name', 'Время работы':'Uptime',
    'с момента включения':'since power-on', 'свободно':'free',
    'Ввод':'Input', 'Указатель':'Pointer', 'Мышь или трекпад':'Mouse or trackpad',
    'подключён':'connected', 'не найден':'not found',
    'Сенсорный экран':'Touch screen', 'не обнаружен':'not detected',
    'Геймпады':'Gamepads', 'Геймпады не найдены':'No gamepads found',
    'Адаптер не найден':'No adapter found', 'готов':'ready',
    'Камеры, микрофоны и динамики':'Cameras, microphones and speakers',
    'Камеры':'Cameras', 'Звуковые карты':'Sound cards', 'Звуковая карта':'Sound card',
    'Звуковая карта системы':'System sound card',
    'В системе не найдено ни одной':'None found in the system',
    'Питание':'Power', 'Заряд батареи':'Battery charge', 'Заряжается':'Charging',
    'Работа от батареи':'On battery', 'Питание от сети':'On mains power',
    'Батарея не обнаружена':'No battery detected', 'Машина работает от розетки':'The machine runs off the mains',
    'Аудиоустройства системы':'System audio devices',
    'Разрешения приложений':'Application permissions', 'Региональные настройки':'Regional settings',
    'Системные предпочтения':'System preferences', 'Тема оформления':'Colour scheme',
    'Не удалось опросить машину':'Could not query the machine',
    /* прочее */
    ...
    'Недавно использовалось':'Recently used', 'Окон открыто':'Open windows',
