...
#
# telegram-desktop берём из Ubuntu, а не с Flathub: тот тянет за собой
# общую основу в сотни мегабайт, а образ и без того упирается в предел
# размера, который GitHub ставит на файл релиза.
#
