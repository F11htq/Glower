...
window.__win12Import = importFiles;
  ...
  render(win, opts){
    ...
    quick.forEach(([e, n, p]) => {
      ...
      b.ondrop = ev => {
        ...
        const names = JSON.parse(ev.dataTransfer.getData('text/win12') || '[]');
    ...
    function draw(){
      ...
      arr.forEach(it => {
        ...
        n.ondragstart = e => {
          ...
          e.dataTransfer.setData('text/win12', JSON.stringify(sel));
        ...
        if (it.type === 'dir'){
          ...
          n.ondrop = e => {
            ...
            const names = JSON.parse(e.dataTransfer.getData('text/win12') || '[]').filter(x => x !== it.name);
